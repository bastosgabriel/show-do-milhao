...
class View():
    ...
    def draw_rules():
        ...
        print(" Na segunda fase, R$ 10 mil com incrementos de R$ 10 mil.")
        print(" Na terceira fase, R$ 100 mil com incrementos de R$ 100 mil.")
        ...
        print(" e está fora do jogo.")
        print(" Se o jogador erra a pergunta final, não leva prêmio algum.")
        print("4. PODERES ")
        print(" O jogador possui dois poderes: pular pergunta e usar as cartas")
        print(" Pular pergunta realiza a troca da pergunta atual, mas sem avançar")
        print(" nas fases/premiações do jogo.")
        print(" Usar as cartas te dá a opção de escolher uma dentre 4 cartas ocultas.")
        print(" Dependendo da carta tirada, o jogador desabilita um determinado número")
        print(" de respostas erradas. ")
        print(" Rei: nenhuma resposta eliminada")
        print(" Ás: 1 resposta eliminada ")
        print(" 2: 2 repostas eliminadas ")
        print(" 3: 3 repostas eliminadas ")
